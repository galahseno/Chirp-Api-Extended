package com.seno.chirp.infra.storage

import com.seno.chirp.domain.exception.InvalidProfilePictureException
import com.seno.chirp.domain.exception.StorageException
...
class SupabaseStorageService(
    ...
    fun generateSignedUploadUrl(
        ...
        val extension = allowedMimeType[mimeType]
    ...
    companion object {
        private val allowedMimeType = mapOf(
            "image/jpeg" to "jpg",
            "image/jpg" to "jpg",
            "image/png" to "png",
            "image/webp" to "webp"
